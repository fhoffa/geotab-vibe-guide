...
> [!TIP]
> **See the Gem in action first:** In our [kickoff webinar](https://www.youtube.com/watch?v=Zuazi88lBeg), Felipe live-demos the Gem — building a trip auditor and an animal-speed fleet map from scratch in minutes.
